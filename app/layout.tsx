...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${GeistSans.variable} ${GeistMono.variable}`} suppressHydrationWarning>
      ...
      <body className={`${GeistSans.variable} ${GeistMono.variable} min-h-screen bg-gray-background text-gray-1200 antialiased flex flex-col`} suppressHydrationWarning>
        ...
        <ThemeProvider>
          ...
          <footer className="content-width w-full mx-auto h-16 flex items-center justify-between border-t border-gray-300 dark:border-gray-600 px-8">
            <p className="text-primary text-sm">© {new Date().getFullYear()} Bernardo Trindade de Abreu</p>
