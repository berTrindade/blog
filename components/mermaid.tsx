  ...
  useEffect(() => {
    mermaid.initialize({
      ...
      themeVariables: isDark ? {
        ...
        border1: '#3c3c3c',
        border2: '#4a4a4a',
        arrowheadColor: '#6e6e6e',
        clusterBkg: '#252526',
        clusterBorder: '#3c3c3c',
        defaultLinkColor: '#6e6e6e',
        titleColor: '#d4d4d4',
        ...
        sectionBkgColor2: '#2d2d2d',
        excludeBkgColor: '#1e1e1e',
        taskBorderColor: '#3c3c3c',
        taskBkgColor: '#252526',
        taskTextLightColor: '#d4d4d4',
        taskTextColor: '#d4d4d4',
        taskTextDarkColor: '#d4d4d4',
        taskTextOutsideColor: '#d4d4d4',
        taskTextClickableColor: '#6e6e6e',
        activeTaskBorderColor: '#4a4a4a',
        activeTaskBkgColor: '#2d2d2d',
        gridColor: '#3c3c3c',
        doneTaskBkgColor: '#1e1e1e',
        doneTaskBorderColor: '#3c3c3c',
        critBorderColor: '#6e6e6e',
        critBkgColor: '#2d2d2d',
        taskTextCriticalColor: '#d4d4d4',
        todayLineColor: '#6e6e6e',
        labelColor: '#d4d4d4',
        errorBkgColor: '#1e1e1e',
